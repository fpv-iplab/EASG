...
if args.split > 0:
    ...
    if args.split < num_split:
        video_uids = video_uids[size_split*(args.split-1):size_split*(args.split)]
...
dset = PyAVSCODDataset(annotations, args.path_to_videos, existing_keys=l.get_existing_keys())
